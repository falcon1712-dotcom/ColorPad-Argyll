...
int main(void)
{
	...
	error_program = "tvarmet";	/* Set global error reporting string */
	check_if_not_interactive();

	/* ====== test with partial derivative ====== */
	...
	rc = varmet(
		...
		1000,			/* Maximum iterations allowed */
		fcn, 			/* Error function to evaluate */
		NULL,			/* No partial derivative function */
		NULL			/* Opaque data needed by function */
	);
